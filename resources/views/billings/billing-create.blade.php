...
<div class="container">
    <div class="card" style="margin-top: 10rem; margin-bottom: 2rem">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('billings.store') }}" method="post" id="paymentForm">
                @csrf
...
Mandiri 996752463746</textarea>
                ...
                <div class="form-group">
                    <label for="total" >No Telpon</label>
                    <input type="text" class="form-control" name="no_tlpn" id="no_tlpn" aria-describedby="total " required />
                   </div>    
                <div class="form-group">
...
<script src="material/js/combo-hide.js"></script>
<script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
<script src="material/js/swipper.js"></script>
</body>
</html>